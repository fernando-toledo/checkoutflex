package io.checkoutflex.application.repository;

import io.checkoutflex.application.CheckoutflexApp;
import io.checkoutflex.application.config.Constants;
import io.checkoutflex.application.config.audit.AuditEventConverter;
import io.checkoutflex.application.domain.PersistentAuditEvent;
...
import static io.checkoutflex.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

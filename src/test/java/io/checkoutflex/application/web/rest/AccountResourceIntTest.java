package io.checkoutflex.application.web.rest;

import io.checkoutflex.application.config.Constants;
import io.checkoutflex.application.CheckoutflexApp;
import io.checkoutflex.application.domain.Authority;
import io.checkoutflex.application.domain.User;
import io.checkoutflex.application.repository.AuthorityRepository;
import io.checkoutflex.application.repository.UserRepository;
import io.checkoutflex.application.security.AuthoritiesConstants;
import io.checkoutflex.application.service.MailService;
import io.checkoutflex.application.service.dto.UserDTO;
import io.checkoutflex.application.web.rest.errors.ExceptionTranslator;
import io.checkoutflex.application.web.rest.vm.KeyAndPasswordVM;
import io.checkoutflex.application.web.rest.vm.ManagedUserVM;
import io.checkoutflex.application.service.UserService;
...
@SpringBootTest(classes = CheckoutflexApp.class)
